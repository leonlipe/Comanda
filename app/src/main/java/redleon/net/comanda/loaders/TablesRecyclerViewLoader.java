 ...
 */
public class TablesRecyclerViewLoader extends
    ...
    private final TablesRecyclerViewAdapter mAdapter;
    public TablesRecyclerViewLoader(TablesRecyclerViewAdapter adapter) {
        mAdapter = adapter;
    }
